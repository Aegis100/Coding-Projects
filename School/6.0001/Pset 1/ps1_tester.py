...
if student_a:
	print('----PART A Test 1----')
	print('RUNNING with salary: 112000, savings_rate: .17, house_cost: 750000')
	...
	print('----PART A Test 2----')
	print('RUNNING with salary: 65000, savings_rate: .20, house_cost: 400000')
	yearly_salary = 65000
	percent_to_save = .20
	home_cost = 400000
	actual = 50
	...
	print('----PART A Test 3----')
	print('RUNNING with salary: 350000, savings_rate: .3, house_cost: 10000000')
...
if student_b:
	print('----PART B Test 1----')
	print('RUNNING with salary: 110000, savings_rate: .15, house_cost: 750000, biannual_raise: .03')
	...
	print('----PART B Test 2----')
	print('RUNNING with salary: 350000, savings_rate: .3, house_cost: 10000000, biannual_raise: .05')
	yearly_salary = 350000
	percent_to_save = .3
	home_cost = 10000000
