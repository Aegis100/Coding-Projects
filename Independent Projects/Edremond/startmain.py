...
def start():
  ...
  time.sleep(1.25)
  print ("This game is a text adventure based on your choices, and you will die a lot.")
  time.sleep(1.25)
  print ("This game will also be added onto as Dylan learns how to actually code.")
  time.sleep(1.25)
